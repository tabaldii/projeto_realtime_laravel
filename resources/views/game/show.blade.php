            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <p class="font-weight-bold h5">Tempo Restante</p>
                        <p id="timer" class="h5 text-danger">Aguardando início</p>
                        <hr>
...
<script>
    ...
    Echo.channel('game')
        ...
        .listen('WinnerNumberGenerated', (e) => {
            ...
            if (bet == winner) {
                resultElement.innerText = 'Você GANHOU';
                resultElement.classList.add('text-success');
            } else {
                resultElement.innerText = 'Você PERDEU';
